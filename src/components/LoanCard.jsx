...
function LoanCard({ data }) {
	...
	return (
		<div className='secondary-bg grid grid-cols-10 sm:grid-cols-12 gap-x-5  rounded-lg p-4 drop-shadow-lg box-border'>
			<div className='flex justify-center items-center col-span-3 sm:col-span-4  p-1'>
				{loanStatus === 'Paid' ? (
					<FontAwesomeIcon
						className={`text-3xl md:text-2xl ${textColor}`}
						icon={faWallet}
					/>
				) : (
					<FontAwesomeIcon
			...
			<div className='col-span-7 sm:col-span-7  p-1'>
				<p className={` mb-3 p-0 text-xs  ${textColor}`}>
					{loanStatus}
				</p>
